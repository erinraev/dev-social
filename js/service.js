angular.module('socialApp').service('mainService', function(){
 ...
 this.getFriendInfo = function(user) {
   friend = user;
   return friend;
 }
    ...
    [
      {
        ...
        'img': 'http://ohl.co/wp-content/uploads/2016/09/Zoo-Animals-Dressed-By-An-Artist-With-Human-Clothes-Look-Surprisingly-Good14.jpg',
      ...
      },
      {
        ...
        'img': 'http://www.placesamazing.com/wp-content/uploads/2014/12/Animals-Dressed-Like-Humans-11.jpg',
      ...
      {
        'name': 'Sid Williams',
        'tagline': 'The only thing we have to fear is... everything',
        'img': 'http://www.placesamazing.com/wp-content/uploads/2014/12/Animals-Dressed-Like-Humans-14.jpg',
        'bio': 'I work at the DMV and like my daily breakfast of coffee with day-old donuts'
      },
      {
        'name': 'Peter Pands',
        'tagline': 'Black and white is the new black',
        'img': 'http://www.placesamazing.com/wp-content/uploads/2014/12/Animals-Dressed-Like-Humans-9.jpg',
        'bio': 'I\'m pretty much the most fabulous panda around. You\'ll often find me catching the latest indie film.'
      }
    ];
